...
const ContactInfo = () => {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col ${darkMode ? "bg-gray-900 text-gray-100" : "bg-gray-100 text-gray-800"}`}
    >
      <main className="w-full max-w-4xl mx-auto p-6">
        ...
        {showForm && (
          <form
            className={`mt-6 p-6 rounded-lg shadow-lg space-y-6 border-2 ${
              darkMode ? "bg-gray-900 text-gray-100 border-gray-700" : "bg-gray-100 text-gray-800 border-gray-300"
            }`}
              ...
              {Object.entries(newContact).map(([field, value]) => (
                <div key={field} className="flex flex-col">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-md border ${darkMode ? "bg-gray-700 border-gray-600 text-gray-100" : "bg-gray-100 border-gray-300 text-gray-800"}`}
                    required
                  />
                </div>
              ))}
        ...
        <div className="flex justify-between mt-8">
          <Link to="/user/select-car">
            <button className="px-6 py-3 bg-gray-400 text-white rounded-md hover:bg-gray-500">Back</button>
          </Link>
          <button
            onClick={handleNext}
